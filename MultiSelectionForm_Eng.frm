VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} MultiSelectionForm_Eng 
   ClientHeight    =   6420
   ClientLeft      =   -315
   ClientTop       =   -1110
   ClientWidth     =   5760
   OleObjectBlob   =   "MultiSelectionForm_Eng.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "MultiSelectionForm_Eng"
...
Private Sub ClearButtonActive_ImageButton_BeforeDragOver(ByVal Cancel As MSForms.ReturnBoolean, ByVal Data As MSForms.DataObject, ByVal X As Single, ByVal Y As Single, ByVal DragState As MSForms.fmDragState, ByVal Effect As MSForms.ReturnEffect, ByVal Shift As Integer)

End Sub

Public Sub ClearButtonActive_ImageButton_Click()
    Call Populate2DimListBox("MasterManufacturerCode", , Language_English) ' Populate with values
End Sub
...
Public Sub FindButtonActive_ImageButton_Click()
    ...
    Set sht = ThisWorkbook.Sheets("MasterManufacturerCode")
    str = FindBox.Value
...
For i = 0 To ListBox1.ListCount - 1
    ...
    If ListBox1.Selected(i) Then
        RequestForm_UserForm_Eng.ProductCode_TextBox.Value = ListBox1.List(i)
    End If
Next i
