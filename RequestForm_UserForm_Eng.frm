VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} RequestForm_UserForm_Eng 
   ClientHeight    =   9450
   ClientLeft      =   180
   ClientTop       =   690
   ClientWidth     =   10665
   OleObjectBlob   =   "RequestForm_UserForm_Eng.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "RequestForm_UserForm_Eng"
...
Private Sub ClearCurrentRowActive_ImageButton_BeforeDragOver(ByVal Cancel As MSForms.ReturnBoolean, ByVal Data As MSForms.DataObject, ByVal X As Single, ByVal Y As Single, ByVal DragState As MSForms.fmDragState, ByVal Effect As MSForms.ReturnEffect, ByVal Shift As Integer)
...
Private Sub UserForm_Initialize()
    ...
    RequestForm_UserForm_Eng.ProductCode_Label.Visible = True
    ...
    With Ws_MasterGroupCategory
        For counter = 2 To GetBorders("LR", .Name, Wb_Current)
            RequestForm_UserForm_Eng.GroupCategory_Combobox.AddItem .Cells(counter, 2).Value & " | " & .Cells(counter, 1).Value
        Next counter
    End With
    ...
    With Ws_helpSheet
        ' Init combobox "Unit"
        For counter = 2 To 34
            RequestForm_UserForm_Eng.Unit_ComboBox.AddItem .Cells(counter, 2).Value
        Next counter
        ...
        For counter = 2 To 3
            RequestForm_UserForm_Eng.Serialization_ComboBox.AddItem .Cells(counter, 4).Value
        Next counter
    End With
...
Private Sub GroupCategory_Combobox_Change()
    ...
    If GroupCategory_Combobox.Value <> "" Then
        ...
        RequestForm_UserForm_Eng.Group_ComboBox.Clear
            ...
            For counter = 2 To MasterGroup_LR
                If Trim(.Cells(counter, 1).Value) = GroupCategoryCode Then
                    If Trim(.Cells(counter, 4).Value) <> "" And Trim(.Cells(counter, 3).Value) <> "" Then
                        RequestForm_UserForm_Eng.Group_ComboBox.AddItem .Cells(counter, 4).Value & " | " & .Cells(counter, 3).Value
                    End If
                End If
            Next counter
